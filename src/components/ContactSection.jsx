  ...
  const contactMethods = [
    {
      ...
      label: "Email",
      value: "raikarsiddhanth@gmail.com",
      href: "mailto:raikarsiddhanth@gmail.com"
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      href: "https://www.linkedin.com/in/siddhanth-raikar-916a792aa/"
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      label: "GitHub",
      value: "View my code",
      href: "https://github.com/frenemy17"
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
      ...
      label: "Instagram",
      value: "Follow me",
      href: "https://www.instagram.com/raikar.svg/"
    }
  ];
              ...
              <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-black/40 border border-white/20 rounded-lg text-white placeholder-white/40 focus:border-blue-400 focus:outline-none transition-colors"
                    style={{fontFamily: 'var(--font-jetbrains-mono)'}}
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full px-4 py-3 bg-black/40 border border-white/20 rounded-lg text-white placeholder-white/40 focus:border-blue-400 focus:outline-none transition-colors resize-none"
                    style={{fontFamily: 'var(--font-jetbrains-mono)'}}
            ...
            <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 overflow-hidden">
              ...
              <div className="relative z-10 space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {["React", "Next.js", "TypeScript", "Node.js", "Design"].map((skill, index) => (
                    <span 
                      key={index}
